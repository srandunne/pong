...
public class Ball {
    ...
    public void update() throws IOException {
        ...
        if (game.getPanel().getScore(5) > 4)
            JOptionPane.showMessageDialog(null, "Team 1 wins", "Pong", JOptionPane.PLAIN_MESSAGE);
        else if (game.getPanel().getScore(6) > 4)
            JOptionPane.showMessageDialog(null, "Team 2 wins", "Pong", JOptionPane.PLAIN_MESSAGE);
        checkCollision();
    }
