...
public class IceRink extends JPanel implements ActionListener, KeyListener {
     ...
     */
    public IceRink(AirHockey game) {
        this.game = game;
        setBackground(Color.GREEN);
        puck = new Puck(game);
        player1 = new Paddle(game, KeyEvent.VK_UP, KeyEvent.VK_DOWN, 
        		KeyEvent.VK_LEFT, KeyEvent.VK_RIGHT, game.getWidth() - 150, 10, 60);
        player2 = new Paddle(game, KeyEvent.VK_W, KeyEvent.VK_S, 
    ...
    public void increaseScore(int playerNo) throws IOException {
        if (playerNo == 3)
        {
            score2++;
            play("applause_y.wav");
            JOptionPane.showMessageDialog(null, "Team 2 scores!!!!!!!", "AirHockey", JOptionPane.PLAIN_MESSAGE);
        ...
        else if(playerNo == 4)
        {
            score1++;
            play("applause_y.wav");
            JOptionPane.showMessageDialog(null, "Team 1 scores!!!!!", "AirHockey", JOptionPane.PLAIN_MESSAGE);
        }
    }
    /*
